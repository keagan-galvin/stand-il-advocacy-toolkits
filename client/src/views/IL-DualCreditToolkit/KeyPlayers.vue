    ...
    <div class="px-2 px-lg-16">
      ...
      <template v-if="policyGoal === 'Start a new dual credit program'">
        <p>
          ...
          other advocates working towards the same goal? What has stood in the
          way of progress before? Thinking about these questions will help you
          plan your strategy and reach out the right people to answer your
          questions or help you achieve your advocacy goal.
        </p>
        ...
        <div data-aos="fade-up" data-aos-duration="700" data-aos-delay="500">
          ...
          <p class="mb-8">
            Decision makers are the people who have the authority to approve a
            new dual credit program in your school. Often this will be the
            principal, but it could also be the superintendent.
          </p>
          ...
          <v-alert border="left" color="secondary" elevation="0">
            ...
            <v-divider></v-divider>
            <div class="mt-3 mb-2 font-weight-medium">
        ...
        <div data-aos="fade-up" data-aos-duration="700" data-aos-delay="300">
          ...
          <p>
            Allies are people who share your goals and are in a position to
            help. Allies can be parents, students, community member and leaders,
            teachers, school board members, the principal, community college
            staff, really any partner who supports your advocacy goal.
          </p>

          <p class="mb-8">
            Make a list of possible allies. We made a few suggestions on where
            to start below but don't let this list limit you. You should try to
            find as many allies as possible and get creative on where to search
            for allies.
          </p>
        ...
        <div data-aos="fade-up" data-aos-duration="700" data-aos-delay="300">
          ...
          <p>
            ...
            with a higher education institution, which must ensure that the
            course meets college-level rigor and has an
            appropriately-credentialled teacher. The institution of higher
            education can be a community college or a four-year college or
            university. Your local community college is the most likely partner,
          ...
          <v-alert border="left" color="secondary" elevation="0">
            <div class="font-weight-bold mb-3">
              Does your community college partner with other local high schools
          ...
          <v-alert border="left" color="secondary" elevation="0">
            ...
            <ul>
              ...
              <li>
                ...
                >
                is a great option for schools struggling to overcome long
                commutes to a community college or an acute teacher shortage.
              </li>
            </ul>
          </v-alert>
        </div>
