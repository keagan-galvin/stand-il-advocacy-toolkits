  ...
  <v-container>
    ...
    <div class="py-5 px-2 px-lg-16 text-center mx-auto">
      <p>
        ...
        the confidence boost needed to continue their studies after high school.
        For other students, the low price-tag of a dual credit course is an
        excellent way to explore career pathways or get a jump start on the
        general education credits required for a postsecondary degree.
      </p>
      <p>
      ...
      <p class="mb-6">
        ...
        new course, or start a brand new dual credit program this toolkit will
              ...
              <v-tab-item>
                ...
                >
                  <v-card-text>
                    ...
                    create personalized handouts and other materials you'll use
